...
It loads pre-trained models and preprocessors (encoder, label binarizer)
and provides a predict function that:
...
The model and preprocessors are loaded once at module import time for
efficiency.
"""
...
def predict(data):
    ...
    Transforms input census data using the pre-trained encoder and
    generates an income prediction using the trained Random Forest model.
    ...
    -------
    str
        Prediction label: ">50K" if income exceeds $50K, "<=50K"
        otherwise
    """
