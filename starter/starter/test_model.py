...
class TestDataProcessing:
    ...
    def sample_data(self):
        ...
        data = pd.DataFrame({
            'age': [25, 45, 35, 28, 55],
            'workclass': [
                'Private', 'Self-emp-not-inc', 'Private', 'Government',
                'Private'
            ],
            'education': [
                'Bachelors', 'Masters', 'HS-grad', 'Bachelors', 'Doctorate'
            ],
            'marital-status': [
            ...
            'occupation': [
                'Tech-support', 'Exec-managerial', 'Craft-repair',
                'Adm-clerical', 'Prof-specialty'
            ],
            'relationship': [
                'Not-in-family', 'Husband', 'Not-in-family', 'Own-child',
                'Husband'
            ],
...
class TestDataSlices:
    ...
    def test_performance_on_slices_returns_dict(
        self, sample_data_with_predictions
    ):
        """Test that performance_on_categorical_slices returns dict."""
    ...
    def test_performance_on_slices_contains_features(
        self, sample_data_with_predictions
    ):
    ...
    def test_performance_on_slices_has_metrics(
        self, sample_data_with_predictions
    ):
